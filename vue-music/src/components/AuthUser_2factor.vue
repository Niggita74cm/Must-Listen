<template>
  ...
  import AuthUserForm_2factor from './AuthUserForm_2factor.vue';
  ...
  .content-container {
    display: grid;
    grid-template-columns: 1fr 1fr; /* Равные ширины для обеих колонок */
    gap: 20px; /* Отступ между колонками */
  }
  
  .image-row {
    /* Стили для компонента ImageRow */
  }
